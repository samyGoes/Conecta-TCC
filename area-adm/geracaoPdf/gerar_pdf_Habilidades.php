...
$query_habilidades = "SELECT codHabilidadeServico, nomeHabilidadeServico  FROM tbhabilidadeservico";

$resultado_habilidades = $conectar->prepare ($query_habilidades);

$resultado_habilidades->execute();
...
ENDHTML;
    ...
    while ($row_habilidade = $resultado_habilidades->fetch(PDO::FETCH_ASSOC)) {
        extract($row_habilidade);
        $html.= "<b>Numero do cadastro: </b> $codHabilidadeServico <br>";
        $html.= "<b>Habilidade: </b> $nomeHabilidadeServico <br>";
        $html.= "<hr>";
    }
