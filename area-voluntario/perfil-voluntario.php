    ...
    <body>
        ...
        <main>
            ...
            <section class="card-completo">
                    ...
                    session_start();
                        $info=$conectar->prepare("SELECT nomeVoluntario, idadeVoluntario, emailVoluntario, numFoneVoluntario, cidadeVoluntario, estadoVoluntario, paisVoluntario FROM tbVoluntario
                                                    INNER JOIN tbFoneVoluntario
                                                        ON tbFoneVoluntario.codVoluntario = tbVoluntario.codVoluntario");
                        $user =$conectar->prepare("SELECT codVoluntario FROM tbVoluntario");
                        print_r($user);
                        $info->bindValue(1, 'codVoluntario', $user);
                        $info->execute();
                    ...
                    <div class="ocultar-sessao">
                        <div class="dados-pessoais-1">
                            ...
                            if ($result){
                                ...
                                $idadeVoluntario = $result['idadeVoluntario'];
                        ...
                        <div class="dados-pessoais-2">
                            <p class="dados">idade: <span><?php echo ($idadeVoluntario); ?></span></p>
